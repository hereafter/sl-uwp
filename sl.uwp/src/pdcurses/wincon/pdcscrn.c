...
#ifdef WINDOWS_UWP
#define RegQueryValueExA(X, Y, Z, W, T) (0) 
#define RegQueryValueEx(X, Y, Z, W, T) (0) 
#define RegQueryValueExW(X, Y, Z, W, T) (0) 
#define RegOpenKeyEx(X, Y, Z, W, T) (0)
#define RegCloseKey(X) (0)
#endif
